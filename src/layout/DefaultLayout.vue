  ...
  <div class="flex h-screen container mx-auto relative"> 
    ...
    <div class="w-20 lg:w-1/5 pt-5 pl-5 pr-5 lg:ml-10 flex flex-col justify-between border-r border-gray-200 dark:border-gray-800">
      <div class="flex flex-col items-center lg:items-start">
        ...
        <div class="w-full lg:pr-3 flex justify-center shadow-[0_15px_30px_-25px_rgba(0,0,0,0.5)] dark:shadow-[0_25px_25px_-25px_rgba(255,255,255,0.5)]">
            <button @click="showTweetModal = true" class="mt-3 bg-primary text-white lg:w-full lg:h-14 h-10 w-full rounded-full hover:bg-dark">
        ...
        <div class="w-full lg:pr-3 flex justify-center mt-7">
            <button type="button" class="px-2 mb-1" @click="toggleDarkMode" :class="this.$store.state.darkmode ? 'dark' : ''">
                <i class="far fa-sun  border-2 border-gray-800 text-yellow-50 lg:px-5 px-3 py-2 dark:bg-gray-800 rounded-full lg:text-base text-xl dark:hover:bg-opacity-80" :class="isDark ? 'hidden' : 'block'"> <span class="hidden lg:inline-block pl-0 lg:pl-2 text-white font-light"> 라이트모드</span></i>
                <i class="fas fa-moon  border-2 border-blue-600  text-blue-600 lg:px-5 px-3 py-2 rounded-full lg:text-base text-xl hover:bg-gray-50" :class="isDark ? 'block' : 'hidden'"> <span class="hidden lg:inline-block pl-0 lg:pl-2 font-light"> 다크모드</span></i>
            </button>
        </div>
      </div>
    ...
    <div class="absolute bottom-20 lg:left-10 left-5 border-2 border-gray-300 dark:border-gray-500 shadow-[0_25px_30px_-25px_rgba(0,0,0,0.5)] dark:shadow-[0_25px_25px_-25px_rgba(255,255,255,0.5)] rounded-lg lg:w-80 w-60 bg-white dark:bg-gray-800" v-if="showProfileDropdown">
      <button class="hover:bg-gray-200 dark:hover:bg-gray-700 border-b border-gray-300 dark:border-gray-600 flex p-3 w-full items-center">
        ...
        <i class="fas fa-solid fa-x text-red-500 ml-auto dark:text-white"  @click="showProfileDropdown = false"></i>
